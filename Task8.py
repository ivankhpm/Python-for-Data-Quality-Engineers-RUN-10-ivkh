...
class File:
    def __init__(self):
        ...
        filetype_prompt = "Please enter the file extension for the news file, txt or json only: "
    ...
    def read_records(self, news_feed):
        ...
        with open(self.file_path, "r") as file:
            if self.filetype_input == 'txt':
                ...
                print("GOOD NEWS: Your file exists \nBAD NEWS: only txt and json files are allowed. Please add correct file")
